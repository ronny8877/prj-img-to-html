...
img.createElements = function (element = "div", colors = []) {
	...
	for (let i = 0; i < colors.length; i++) {
		...
		div.style.height = `${PIXEL_SIZE / 2}px`;
...
//TODO: fix aspect ratio problemo
//TODO: allow user input to control different parameters
//TODO: add a slider to control quality
